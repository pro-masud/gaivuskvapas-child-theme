<?php 
    wp_enqueue_style('gv-bootstrap');
    wp_enqueue_style('gv-main-css');
?>
<!DOCTYPE html>
...
<header class="sticky-top gv-header">
    <?php if(get_theme_mod('gv_delivery_info')): ?>
        <div class="gv-header-top">
            <div class="container gv-container">
                <div class="row">
                    <div class="col-12">
                        <div class="gv-header-text">
                            <p><?php echo esc_html(get_theme_mod('gv_delivery_info')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="gv-header-warp">
                        ...
                        <div class="gv-card">
                            <div class="gv-info">
                                <?php if(get_theme_mod('gv_phone_number')): ?>
                                    <a href="tel:<?php echo esc_attr(get_theme_mod('gv_phone_number', '+370 666 29977')); ?>">
                                        ...
                                        </svg> <?php echo esc_html(get_theme_mod('gv_phone_number', '+370 666 29977')); ?>
                                    </a>
                                <?php endif; ?>
                                <?php if(get_theme_mod('gv_email_address')): ?>
                                    <a href="mailto: <?php echo esc_attr(get_theme_mod('gv_email_address', 'info@gaivuskvapas.lt')); ?>"><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <?php echo esc_html(get_theme_mod('gv_email_address', 'info@gaivuskvapas.lt')); ?>
                                    </a>
                                <?php endif; ?>
                            </div>
                            <div class="gv-card-info">
                                    ...
                                    if (shortcode_exists('xoo_wsc_cart')) {
                                        ...
                                        ?>
                                            <a href="<?php echo esc_url($cart_url); ?>">
                                                ...
                                                <?php esc_html_e("Krepšelis", "gaivuskvapas"); ?>
                                            </a>
                                        <?php 
                                    }
                                ...
                                ?>
                                    <a href="<?php echo  esc_url($my_account_url); ?>">
                                        ...
                                        <?php esc_html_e("Paskyra", "gaivuskvapas"); ?>
                                    </a>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="collapse navbar-collapse menu-menu" id="navbarSupportedContent">
                                    <?php
                                       wp_nav_menu(array(
                                        ...
                                        'menu_id'			=> "pro-masud-id", 
                                        'container'			=> "pro-cont",
                                        'container_class'	=> "",
                                        'container_id'		=> "",
                                        'fallback_cb'		=> "gv_header_mega_menu",
                                    ));
                                    ?>
                                    <!-- <ul class="">
                                        <li>
                            ...
                            <?php if(has_nav_menu('header-right-menu')): ?>
                                <div class="gv-choose-item">
                                    <div class="gv-dropdown-container">
                                        <div class="gv-dropdown-toggle click-dropdown">
                                            <?php esc_html_e('Informacija'); ?> <i class="fa-solid fa-angle-down"></i>
                                        </div>
...
<div class="offcanvas offcanvas-start main-menu-offcanvas" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
        ...
        <div class="gv-info">
            <?php if(get_theme_mod('gv_phone_number')): ?>
                <a href="tel: <?php echo esc_html(get_theme_mod('gv_phone_number')); ?>"><i class="fa-solid fa-phone"></i> <?php echo esc_html(get_theme_mod('gv_phone_number')); ?></a>
            <?php endif; ?>
            <?php if(get_theme_mod('gv_email_address')): ?>
                <a href="mailto:<?php echo esc_html(get_theme_mod('gv_email_address')); ?>"><i class="fa-solid fa-envelope"></i> <?php echo esc_html(get_theme_mod('gv_email_address')); ?></a>
            <?php endif; ?>
        </div>
    </div>
</div>
