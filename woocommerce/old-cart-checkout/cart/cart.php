...
<div class="woocommerce row <?php echo $row_classes; ?>">
		...
		<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
							...
							<td class="product-remove">
								<?php
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><img src="/wp-content/themes/gaivuskvapas-child/svg/delete.png" /></a>',
			...
			<?php if ( wc_coupons_enabled() ) { ?>
				...
				<?php } ?>
					...
					<button type="submit" class="button primary mb-0" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
	...
	<div class="cart-collaterals large-12 col pb-0 mt">
