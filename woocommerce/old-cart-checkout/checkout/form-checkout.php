...
<form name="checkout" method="post" class="checkout woocommerce-checkout <?php echo esc_attr( $wrapper_classes ); ?>" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<div class="row mt <?php echo esc_attr( $row_classes ); ?>">
		<div class="large-12 col pb-0 <?php echo esc_attr( $main_classes ); ?>">
			<?php if ( $checkout->get_checkout_fields() ) : ?>

				<?php do_action( 'woocommerce_checkout_before_customer_details' ); ?>

				<div class="row" id="customer_details">
					<div class="col checkout-heading-col pb-0 dark">
					...
					<div class="col">
						<div class="col-inner checkout-fields-wrapper">

							<div class="row">
								<div class="clear col large-6">
